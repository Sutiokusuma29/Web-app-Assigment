...
func (c *categoryRepository) Update(id int, category model.Category) error {
	...
	if err != nil {
		return fmt.Errorf("failed to find category with ID %d: %v", id, err)
	}
	...
	if err != nil {
		return fmt.Errorf("failed to update category with ID %d: %v", id, err)
	}
	return nil 
}
...
func (c *categoryRepository) Delete(id int) error {
	...
	_, err := c.filebasedDb.GetCategoryByID(id)
	if err != nil {
		return fmt.Errorf("failed to find category with ID %d: %v", id, err)
	}
	...
	if err != nil {
		return fmt.Errorf("failed to delete category with ID %d: %v", id, err)
	}
